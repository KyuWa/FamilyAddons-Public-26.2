...
class KeybindsConfig {
    ...
    @Expose @JvmField
    @ConfigOption(name = "GFS", desc = "Get-from-sack keybinds: one key per item, each topping you back up from your sacks.")
    @ConfigEditorAccordion(id = 30)
    var gfsAccordion = false

    @Expose @JvmField
    @ConfigAccordionId(id = 30)
    @ConfigOption(name = "Ender Pearl", desc = "")
    ...
    @Expose @JvmField
    @ConfigAccordionId(id = 30)
    @ConfigOption(name = "Inflatable Jerry", desc = "")
    ...
    @Expose @JvmField
    @ConfigAccordionId(id = 30)
    @ConfigOption(name = "Toxic Arrow Poison", desc = "")
    ...
    @Expose @JvmField
    @ConfigAccordionId(id = 30)
    @ConfigOption(name = "Twilight Arrow Poison", desc = "")
